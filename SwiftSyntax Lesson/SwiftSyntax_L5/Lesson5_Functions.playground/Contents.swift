...
class MovieArchive {
    func fileterByYear(year:Int, movies: Dictionary<String, Int>) -> [String]{
...
var myAchive = MovieArchive()
myAchive.fileterByYear(1982, movies: aiThemedMovies)
